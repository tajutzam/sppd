            ...
            <tr>
                ...
                <td>
                    <div style="float: right;  padding: 0%; margin: 0px;">
                        <p style="margin-bottom: 0%; margin-top: 0%; font-size:11px;">Lunas dibayar pada tanggal - {{\Carbon\Carbon::now()->format('Y-m-d')}}
                        </p>
                        ...
                        <p style="margin-bottom: 0%; margin-top: 0%; font-size:11px;">NIP. {{$data['treasurer']['nip']}}
                        </p>
                        <p> </p>
                        <p></p>
                    </div>
