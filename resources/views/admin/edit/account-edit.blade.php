@extends('layouts.app')
<title>Edit Akun - SPPD Puskesmas Ketrowonojoyo</title>
@section('content')
    <style>
        .custom-border {
        ...
        height: 0.7px; ">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('account-put', ['id'=>$account->id]) }}" method="post" class="form-valide-with-icon needs-validation" novalidate="">
                                @csrf
                                @method('put')
                                <div class="mb-3">
