\@extends('layouts.app')
<title>Tambah Kategori - SPPD Puskesmas Ketrowonojoyo</title>
@section('content')
    <style>
        .custom-border {
        ...
        height: 0.7px; ">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('categories-post') }}" method="POST" class="form-valide-with-icon needs-validation" novalidate="">
                                @method('post')
                                @csrf
                                <div class="mb-3">
